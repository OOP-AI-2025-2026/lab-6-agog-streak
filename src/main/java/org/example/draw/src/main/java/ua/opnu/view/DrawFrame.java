...
public class DrawFrame extends JFrame {
    ...
    private ua.opnu.view.PaintSurface surface;
    ...
    public DrawFrame(String title) {
        ...
        surface = new ua.opnu.view.PaintSurface();
    ...
    private JPanel setButtonPanel() {
        ...
        ua.opnu.view.BigTextButton rect = new ua.opnu.view.BigTextButton("Rectangle");
        ...
        ua.opnu.view.BigTextButton rounded_rect = new ua.opnu.view.BigTextButton("Rounded rect.");
        ...
        // 3. Кнопка для еліпса
        ua.opnu.view.BigTextButton ellipseButton = new ua.opnu.view.BigTextButton("Ellipse");
        ...
        ua.opnu.view.BigTextButton clearButton = new ua.opnu.view.BigTextButton("Clear");
